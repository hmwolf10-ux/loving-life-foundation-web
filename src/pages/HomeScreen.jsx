    ...
    <div className="home">
      <section className="hero">
        ...
        <div className="hero__mark" aria-hidden="true">
          <img src="../../assets/logos/navy.png" alt="" />
        </div>
      </section>
      ...
      <section className="programs">
        ...
        <div className="programs__grid">
          <article className="program-card" onClick={() => onNav("scholarship")}>
            <div className="program-card__img" style={{ backgroundImage: "url(../../assets/photos/scholarship-hero.png)", backgroundPosition: "center 30%" }} />
          ...
          <article className="program-card" onClick={() => onNav("tournament")}>
            <div className="program-card__img" style={{ backgroundImage: "url(../../assets/photos/golf-tournament-3.jpg)" }} />
            <div className="program-card__body">
          ...
          <article className="program-card" onClick={() => onNav("story")}>
            <div className="program-card__img" style={{ backgroundImage: "url(../../assets/photos/community-event-1.jpg)", backgroundPosition: "center 20%" }} />
            <div className="program-card__body">
