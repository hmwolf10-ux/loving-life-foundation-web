  ...
  return (
    <div className="page story">
      <section className="story-hero">
        <img src="public/assets/photos/story-hero.jpg" alt="Friends and supporters gathered at the Loving Life Foundation golf tournament" className="story-hero__img" />
